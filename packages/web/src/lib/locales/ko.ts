...
const ko: Record<string, string> = {
  ...
  "settings.section.apiKeys": "MCP API 키",
  "settings.apiKeys.intro":
    "MCP 클라이언트(Claude, Cursor 등)를 Klorn 받은편지함에 연결하는 키입니다. 키는 MCP 엔드포인트에서만 동작하며 계정의 다른 영역에는 쓸 수 없습니다.",
  "settings.apiKeys.namePlaceholder": "예: claude-desktop",
  "settings.apiKeys.create": "키 만들기",
  "settings.apiKeys.creating": "생성 중...",
  "settings.apiKeys.createdNotice": "지금 복사하세요 — 다시 표시되지 않습니다.",
  "settings.apiKeys.copy": "복사",
  "settings.apiKeys.copied": "키를 복사했습니다.",
  "settings.apiKeys.dismiss": "완료",
  "settings.apiKeys.empty": "아직 API 키가 없습니다.",
  "settings.apiKeys.revoke": "폐기",
  "settings.apiKeys.revokedChip": "폐기됨",
  "settings.apiKeys.revokedToast": "키를 폐기했습니다.",
  "settings.apiKeys.revokeConfirm.title": "키 폐기",
  "settings.apiKeys.revokeConfirm.message":
    '"{name}" 키를 폐기할까요? 이 키를 쓰는 클라이언트는 즉시 중단됩니다.',
  "settings.apiKeys.createFailed": "키를 만들지 못했습니다.",
  "settings.apiKeys.revokeFailed": "키를 폐기하지 못했습니다.",
  "settings.section.rules": "규칙",
  "settings.rules.intro":
    "내 말로 규칙을 쓰면 Klorn이 발신자/도메인 핀으로 컴파일합니다. 저장 전 직접 확인합니다.",
  "settings.rules.placeholder": "예: acme.com에서 오는 건 전부 Silent, boss@acme.com은 항상 Push",
  "settings.rules.compile": "규칙 만들기",
  "settings.rules.compiling": "컴파일 중...",
  "settings.rules.review": "저장 전 확인",
  "settings.rules.unsupported": "핀으로 표현하지 못한 부분:",
  "settings.rules.apply": "규칙 저장",
  "settings.rules.applying": "저장 중...",
  "settings.rules.cancel": "버리기",
  "settings.rules.empty": "아직 규칙이 없습니다.",
  "settings.rules.applied": "규칙 {n}개를 저장했습니다.",
  "settings.rules.compileFailed": "규칙을 컴파일하지 못했습니다.",
  "settings.rules.applyFailed": "규칙을 저장하지 못했습니다.",
  "settings.rules.deleteConfirm.title": "규칙 삭제",
  "settings.rules.deleteConfirm.message": "{pin} 핀을 삭제할까요?",
  "settings.rules.deleted": "규칙을 삭제했습니다.",
  "settings.rules.deleteFailed": "규칙을 삭제하지 못했습니다.",
  ...
  "emailDetail.toolbar.action.unsubscribe": "구독 취소",
  "emailDetail.toast.unsubscribed": "구독을 취소했습니다.",
  "emailDetail.toast.unsubscribeLink": "발신자의 구독 취소 페이지를 열었습니다.",
  "emailDetail.error.unsubscribe": "이 발신자의 구독을 취소하지 못했습니다.",
