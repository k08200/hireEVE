...
const en: Record<string, string> = {
  ...
  "settings.section.apiKeys": "MCP API keys",
  "settings.apiKeys.intro":
    "Keys for connecting MCP clients (Claude, Cursor…) to your Klorn inbox. A key works only on the MCP endpoint — never on the rest of the account.",
  "settings.apiKeys.namePlaceholder": "e.g. claude-desktop",
  "settings.apiKeys.create": "Create key",
  "settings.apiKeys.creating": "Creating...",
  "settings.apiKeys.createdNotice": "Copy this key now — it will not be shown again.",
  "settings.apiKeys.copy": "Copy",
  "settings.apiKeys.copied": "Key copied.",
  "settings.apiKeys.dismiss": "Done",
  "settings.apiKeys.empty": "No API keys yet.",
  "settings.apiKeys.revoke": "Revoke",
  "settings.apiKeys.revokedChip": "Revoked",
  "settings.apiKeys.revokedToast": "Key revoked.",
  "settings.apiKeys.revokeConfirm.title": "Revoke key",
  "settings.apiKeys.revokeConfirm.message":
    'Revoke "{name}"? Clients using it will stop working immediately.',
  "settings.apiKeys.createFailed": "Could not create the key.",
  "settings.apiKeys.revokeFailed": "Could not revoke the key.",
  ...
  "settings.rules.placeholder":
    "e.g. everything from acme.com goes to Silent; boss@acme.com is always Push",
  "settings.rules.compile": "Make rules",
  "settings.rules.compiling": "Compiling...",
  "settings.rules.review": "Review before saving",
  "settings.rules.unsupported": "Couldn't be expressed as pins:",
  "settings.rules.apply": "Save rules",
  "settings.rules.applying": "Saving...",
  "settings.rules.cancel": "Discard",
  "settings.rules.empty": "No rules yet.",
  "settings.rules.applied": "{n} rule(s) saved.",
  "settings.rules.compileFailed": "Could not compile that rule.",
  "settings.rules.applyFailed": "Could not save the rules.",
  "settings.rules.deleteConfirm.title": "Remove rule",
  "settings.rules.deleteConfirm.message": "Remove the pin for {pin}?",
  "settings.rules.deleted": "Rule removed.",
  "settings.rules.deleteFailed": "Could not remove the rule.",
  ...
  "emailDetail.toolbar.action.unsubscribe": "Unsubscribe",
  "emailDetail.toast.unsubscribed": "Unsubscribed.",
  "emailDetail.toast.unsubscribeLink": "Opened the sender's unsubscribe page.",
  "emailDetail.error.unsubscribe": "Could not unsubscribe from this sender.",
