      ...
      <article className="mx-auto max-w-4xl px-6 py-14">
        ...
        <div className="mt-12 space-y-10">
          ...
          <Section title="Billing, Cancellation, and Refunds">
            <p>
              Klorn Pro is a monthly subscription at $8.99/month, billed through Paddle. Paddle
              is the merchant of record for these purchases: Paddle handles the payment, issues
              the receipt, and appears on your card or bank statement.
            </p>
            <p>
              New subscriptions start with a 7-day free trial. You are not charged during the
              trial. Cancel before it ends and you are never billed.
            </p>
            <ul className="list-disc space-y-2 pl-5">
              <li>
                <strong>Cancel anytime.</strong> Cancellation stops future renewals. Your Pro
                access continues until the end of the period you already paid for.
              </li>
              <li>
                <strong>14-day refund on a first paid month.</strong> If Klorn is not for you,
                email us within 14 days of your first charge and we will refund it in full — no
                explanation needed.
              </li>
              <li>
                ...
                — an outage, a failed sync, a charge you did not expect — write to us and we will
                make it right.
              </li>
              <li>
            ...
            <p>
              ...
              from the address on your Klorn account. Refunds are returned to the original
              payment method; the time it takes to appear depends on your bank.
            </p>
            <p>
