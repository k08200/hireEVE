    ...
    <main className="min-h-[calc(100vh-3.5rem)]">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-8 leading-relaxed">
          EVE handles email, calendar, tasks, notes, contacts, Slack, web search, and more — autonomously.
          30+ tools. One AI employee. Built for solo founders who wear too many hats.
        </p>
      ...
      <section className="border-t border-gray-800 py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-2xl font-bold mb-3">Stop juggling. Start delegating. / 혼자 다 하지 마세요.</h2>
          <p className="text-gray-400 mb-6">Free to start. No credit card required. / 무료로 시작하세요.</p>
          <Link
            href="/chat"
